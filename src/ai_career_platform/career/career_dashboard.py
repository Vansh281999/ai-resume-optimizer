...
class CareerDashboard:
    ...
    def roadmap(self, current_skills: List[str], target_role: str, context: str = "") -> CareerRoadmap:
        ...
        prompt = (
            ...
            "Include skill progressions and estimated timeline months only. "
            ...
            "learning_resources (list of strings), estimated_months. Levels are 0-100.\n\n"
        ...
        try:
            ...
            return CareerRoadmap(
                ...
                salary_progression={}  # Empty - frontend shows "unavailable"
            )
